...
You can use the `bg_color` parameter to make any of [the available themes](/frontend/docs/themes/) transparent. This is done by setting the `bg_color` to a color with a transparent alpha channel (i.e. `bg_color=00000000`):
...
| `theme`         | Name of the theme, choose from [all available themes](/frontend/docs/themes/).                          | enum                                                              | `default`     |
